...
#   3. python3 gen_session.py
#   4. python3 main.py
#   5. python3 blacmusicbot.py
#
# Commands:
...
# Must happen before anything else — fixes get_event_loop() crash on Python 3.14
import asyncio
...
try:
    ...
    print("ERROR: py-tgcalls not installed. Run: bash install.sh")
    sys.exit(1)
...
try:
    ...
    try:
        from pytgcalls.exceptions import AlreadyActiveGroupCall as AlreadyJoinedError
    except ImportError:
...
try:
    ...
    try:
        from pytgcalls.exceptions import NotInGroupCallError as NotInCallError
    except ImportError:
